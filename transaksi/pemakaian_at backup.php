...
"); ?>
  ...
  <html lang="id">
    ...
    <body class="hold-transition sidebar-mini">
      <div class="wrapper">
        <?php $page='pemakaian_at' ; include "../layout/navbar.php"; include
        "../layout/sidebar.php"; ?>
                  ...
                  <div class="card-body">
                    <div class="row">
                      ...
                      <div class="col-md-3">
                        ...
                        <input type="text" class="form-control form-control-sm" value="<?= htmlspecialchars($barang['nama_barang']) ?>"
                        readonly>
                      ...
                      <div class="col-md-3">
                        ...
                        <input type="text" id="saldo" class="form-control form-control-sm" readonly
                        value="0">
                      </div>
                    </div>
                    <hr>
                    ...
                    <div class="form-group mt-3">
                      ...
                      <textarea name="keterangan" rows="2" class="form-control form-control-sm"
      ...
      <script>
        document.getElementById('id_supplier').addEventListener('change',
        function() {

...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 24, 2026 at 01:59 AM
...
--
-- Table structure for table `sub_mutasi`
--

CREATE TABLE `sub_mutasi` (
...
--
-- Indexes for table `sub_mutasi`
--
ALTER TABLE `sub_mutasi`
...
--
-- AUTO_INCREMENT for table `sub_mutasi`
--
ALTER TABLE `sub_mutasi`
...
--
ALTER TABLE `mutasi`
  ADD CONSTRAINT `fk_mutasi_sub` FOREIGN KEY (`id_sub`) REFERENCES `sub_mutasi` (`id_sub`) ON DELETE SET NULL,
...
--
-- Constraints for table `sub_mutasi`
--
ALTER TABLE `sub_mutasi`
  ADD CONSTRAINT `sub_mutasi_ibfk_1` FOREIGN KEY (`id_jenis`) REFERENCES `jenis_mutasi` (`id_jenis`);
COMMIT;

...
<div class="wrapper">
  ...
  <div class="content-wrapper p-3">
    ...
    <section class="content-header">
      <h1>Barang Masuk</h1>
      <small>Input barang masuk harian / stok awal</small>
    </section>
    ...
    <section class="content">
      ...
      <div class="card card-primary">
        ...
        <form method="post" action="barang_masuk_simpan.php">
          <div class="card-body">
            ...
            <div class="form-group">
              ...
              <textarea name="keterangan" class="form-control" placeholder="Stok awal / pembelian / koreksi"></textarea>
            </div>

...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 21, 2026 at 05:57 AM
...
INSERT INTO `bkbriket` (`id_bk`, `tanggal`, `id_barang_briket`, `lokasi`, `keterangan`, `created_at`) VALUES
(1, '2026-02-11', 8, 'DCS1', '', '2026-02-11 03:03:20'),
(2, '2026-02-13', 8, 'DCS1', '', '2026-02-13 07:16:31'),
(3, '2026-02-18', 8, 'DCS 1', '', '2026-02-18 02:42:55'),
(4, '2026-02-19', 9, 'DCS2', '', '2026-02-19 02:30:20');
...
(5, 'b1', 'AFKIR', 'RAW_MATERIAL', NULL),
(6, 'D4', 'BRIKET', 'RAW_MATERIAL', NULL);
...
--
ALTER TABLE `bkbriket_bongkar`
  MODIFY `id_bongkar` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `mutasi`
  MODIFY `id_mutasi` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=39;
